  ...
  <div class="signup">
    ...
    <form v-on:submit.prevent="submit()">
      ...
      <div class="form-group">
        ...
        <small v-if="first_name.length <= 20">You have {{ 20 - first_name.length }} characters remaining</small>
      ...
      <div class="form-group">
        ...
        <small v-if="last_name.length <= 20">You have {{ 20 - last_name.length }} characters remaining</small>
